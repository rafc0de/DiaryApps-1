...
public class ListNotesAdapter extends RecyclerView.Adapter<ListNotesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.tv_title.setText(mLists.get(i).getTitle());
        viewHolder.tv_date.setText(mLists.get(i).getDate());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tv_title = itemView.findViewById(R.id.tvItemListNotesTitle);
            tv_date = itemView.findViewById(R.id.tvItemListNotesDate);
        }
    }
}
